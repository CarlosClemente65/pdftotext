...
namespace pdftotext
{
    ...
    class Program
    {
        ...
        public static string[] filesPDF = new string[0];
        public static string opcion = "-f";
        public static int firstpage = 0;
        public static int lastpage = 0;
        public static bool fOption = false;
        public static bool mOption = false;
        public static bool parametroOk = false;
        static void Main(string[] args)
        {
            ...
            foreach (string archivo in filesPDF)
            {
                ...
                using (PdfDocument pdfDoc = new PdfDocument(new PdfReader(Program.filePath)))
                {
                    ...
                    if (Program.firstpage > pdfDoc.GetNumberOfPages() || Program.lastpage > pdfDoc.GetNumberOfPages())
                    {
                        Console.Clear();
